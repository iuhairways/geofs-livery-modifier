...
async function init(){
    ...
    await fetch("https://raw.githubusercontent.com/iuhairways/geofs-livery-modifier/main/tester.json").then(res => res.json()).then(data => liveryobj = data)
